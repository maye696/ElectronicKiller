"""
Django settings for ElectronicKiller project.
"""
...
DATABASES = {
    'default': {
        ...
        'HOST': MYSQL_HOST,                      # Set to empty string for localhost.  Not used with
...
ROOT_URLCONF = 'ElectronicKiller.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ElectronicKiller.wsgi.application'
